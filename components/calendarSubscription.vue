...
<template>
  <form class="component calendar"  @change="updateSubscription()">
    ...
    <info-box v-if="days.length > 1" type="info" text="you have chosen to auto-invest on multiple days"/>
    <info-box type="warn" text="choosing the 29th, 30th, or 31st will be charged to the last day of the month" />
</form>
</template>
