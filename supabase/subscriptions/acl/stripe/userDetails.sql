...
comment on column acl_stripe__user_details.message_id 
...
comment on column acl_stripe__user_details.message_entity_id 
...
RETURNS TRIGGER AS $$
BEGIN
  INSERT INTO acl_stripe__user_details (message_id, message_entity_id, message_sender, message_created)
