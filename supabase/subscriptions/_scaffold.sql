...
comment on column <<serviceName>>_<<topicName>>.message_id 
...
comment on column <<serviceName>>_<<topicName>>.message_entity_id 
...
RETURNS TRIGGER AS $$
BEGIN
  INSERT INTO <<serviceName>>_<<topicName>> (message_id, message_entity_id, message_sender, message_created)
