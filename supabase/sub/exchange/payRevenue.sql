...
CREATE TABLE "sub_exchange_payRevenue" (
...
RETURNS TRIGGER AS $$
BEGIN
  INSERT INTO "sub_exchange_payRevenue" (message_id, message_entity, message_sender, message_sent)
...
-- Enable RLS
ALTER TABLE "sub_exchange_payRevenue" ENABLE ROW LEVEL SECURITY;