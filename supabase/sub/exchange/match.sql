...
CREATE TABLE "sub_exchange_autoMatchOrders" (
...
RETURNS TRIGGER AS $$
BEGIN
  INSERT INTO "sub_exchange_autoMatchOrders" (message_id, message_entity, message_sender, message_sent)
...
-- Enable RLS
ALTER TABLE "sub_exchange_autoMatchOrders" ENABLE ROW LEVEL SECURITY;