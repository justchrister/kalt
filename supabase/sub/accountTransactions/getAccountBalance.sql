...
CREATE OR REPLACE FUNCTION "sub_accountTransactions_getAccountBalance"()
RETURNS TRIGGER AS $$
BEGIN
...
FOR EACH ROW
EXECUTE FUNCTION "sub_accountTransactions_getAccountBalance"();


-- Set up webhook function 

CREATE OR REPLACE FUNCTION "getAccountBalance/webhooks/accountTransactions"()
RETURNS TRIGGER AS $$
DECLARE 
  response RECORD;
  payload TEXT;
...
AFTER INSERT ON "trigger_accountTransactions_getAccountBalance"
FOR EACH ROW
