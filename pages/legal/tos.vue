<template>
  <main>
    ...
    <block margin="3">
      <h2>Introduction</h2>
      <p>By using our website and services ("Platform"), you agree to these terms of use ("Terms"). These Terms apply to everyone who uses the Platform, whether you're a registered member or just browsing.</p>
      <p><strong>Important: Read these Terms carefully. They include a clause that requires binding arbitration for resolving disputes.</strong></p>
    </block>
    <block margin="half">
      <h2>Updates to these terms</h2>
      <p>We may update these Terms at any time. If we do, we'll notify you on the Platform. Your continued use of the Platform means you agree to the updated Terms.</p>
    </block>
    <block margin="half">
      <h2>Who can use our platform</h2>
      <p>You must be at least 18 years old to use our Platform. By using it, you confirm that you meet this age requirement.</p>
    </block>
    <block margin="half">
      <h2>Ownership and use of content</h2>
      <p>All content on the Platform is our property. You're granted a limited license to use it for personal purposes, as long as you don't remove any copyright notices.</p>
    ...
    <block margin="half">
      <h2>Privacy</h2>
      <p>We collect and process your data to provide our services. We don't share this data with third parties. For data deletion, email us at <a href="mailto:gdpr@ka.lt">gdpr@ka.lt</a>.</p>
    </block>
    <block margin="half">
      <h2>Arbitration clause</h2>
      <p>Disputes between you and Kalt LLC will be resolved by binding arbitration on an individual basis, rather than in court.</p>
    </block>
    <block margin="half">
      <h2>Limitation of liability</h2>
      <p>Kalt LLC is not liable for any damages that result from your use or inability to use the Platform.</p>
    </block>
  </main>
</template>
