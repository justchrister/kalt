...
<template>
  <div class="PageWrapper">
    ...
    <div class='page'>
      <div class="section">
        <Image :images="['/images/dall-e/david_hockney_solar.png']" style="contain"/> 
        <div class="block">
      ...
      <div class="section">
        <Image :images="['/images/dall-e/hockney_pool.png']" style="contain"/>
        <div class="block">
      ...
      <div class="section">
        <Image :images="['/images/dall-e/you_can_feel_good.png']" style="contain"/>
        <div class="block">
      ...
      <div class="section">
        <Image :images="['/images/dall-e/Basquiat_solar.png']" style="contain"/>
        <div class="block">
      ...
      <div class="section">
        <Image :images="['/images/dall-e/relax.png']" style="contain"/>
        <div class="block">
      ...
      <div class="section">
        <Image :images="['/images/dall-e/money.png']" style="contain"/>
        <div class="block">
