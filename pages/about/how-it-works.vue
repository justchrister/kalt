...
<template>
  <div class="PageWrapper">
    ...
    <div class='page'>
      <div class="section">
        <Image :images="['/images/dall-e/david_hockney_solar.png']" type="contain"/> 
        <div class="block">
      ...
      <div class="section">
        <Image :images="['/images/dall-e/hockney_pool.png']" type="contain"/>
        <div class="block">
      ...
      <div class="section">
        <Image :images="['/images/dall-e/you_can_feel_good.png']" type="contain"/>
        <div class="block">
      ...
      <div class="section">
        <Image :images="['/images/dall-e/Basquiat_solar.png']" type="contain"/>
        <div class="block">
      ...
      <div class="section">
        <Image :images="['/images/dall-e/relax.png']" type="contain"/>
        <div class="block">
      ...
      <div class="section">
        <Image :images="['/images/dall-e/money.png']" type="contain"/>
        <div class="block">
